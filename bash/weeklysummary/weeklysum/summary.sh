...
######ATTENTION########ATTENTION################
# Don't forget to add your name to the AddYourName in this file***
#
# Do a search for AddYourName and replace it with your real name with no spaces
# 
# Example  AddYourname$res.doc
#          MikeAddicks$res.doc
#
# This is version 1.0 The next version will have mailing capabilities#####
...
# Change your AddYourName to your real name here
